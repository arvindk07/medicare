...
export const AnalyticsDashboard = () => {
  const analytics = {
    overview: [
      ...
      { title: "Sessions This Month", value: "12,456", change: "+22.1%", trend: "up" },
      { title: "Customer Satisfaction", value: "94.5%", change: "+2.3%", trend: "up" }
    ],
    topPerformers: [
      { name: "TechCorp Inc", revenue: "$450K", sessions: 2340, growth: "+25%" },
      { name: "MegaCorpLtd", revenue: "$380K", sessions: 1890, growth: "+18%" },
      { name: "StartupXYZ", revenue: "$320K", sessions: 1560, growth: "+32%" }
    ],
    regionalData: [
      { region: "North America", revenue: "$1.2M", users: 18500, growth: "+12%" },
      { region: "Europe", revenue: "$890K", users: 14200, growth: "+18%" },
      { region: "Asia Pacific", revenue: "$310K", users: 12900, growth: "+25%" }
    ],
    therapistMetrics: [
      { name: "Dr. Sarah Wilson", sessions: 156, rating: 4.9, revenue: "$18.2K" },
      { name: "Dr. Michael Chen", sessions: 142, rating: 4.8, revenue: "$16.8K" },
      { name: "Dr. Emily Johnson", sessions: 138, rating: 4.7, revenue: "$15.9K" }
    ]
  };
              ...
              {analytics.topPerformers.map((company, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{company.sessions} sessions this month</p>
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Highest performing therapists this month</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {analytics.therapistMetrics.map((therapist, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{therapist.sessions} sessions • ⭐ {therapist.rating}</p>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold text-gray-900">{therapist.revenue}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg">
              ...
              <p className="text-sm text-blue-700">Average session engagement rate</p>
            </div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg">
              <h3 className="text-lg font-semibold text-purple-900 mb-2">Revenue Growth</h3>
