...
import { BarChart, XAxis, YAxis, Bar, ResponsiveContainer, LineChart, Line, CartesianGrid, Tooltip, Legend, PieChart, Pie, Cell } from "recharts";
        ...
        <Card>
          ...
          <CardContent className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={sessionData} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
          ...
          <CardContent className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={outcomeData} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="improvement" stroke="#10b981" strokeWidth={2} activeDot={{ r: 8 }} />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
