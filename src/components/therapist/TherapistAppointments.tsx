...
import { Calendar as CalendarIcon, Clock, Users, Video, Phone } from "lucide-react";
          ...
          <Card className="h-full">
            <CardHeader className="pb-3">
              <CardTitle className="text-xl">
                {date ? format(date, 'MMMM d, yyyy') : 'Today'} - {todayAppointments.length} Appointments
              </CardTitle>
              <CardDescription>
              ...
              <div className="space-y-3">
                ...
                {todayAppointments.length === 0 && (
                  <div className="py-8 text-center text-gray-500">
                    ...
                    <p className="mt-1 text-sm">Use the calendar to select another date or add a new appointment.</p>
                  </div>
                )}
              </div>
            </CardContent>
