...
import { Search, Calendar, FileText, MessageSquare, Phone, VideoIcon, UserPlus } from "lucide-react";
              ...
              filteredPatients.map((patient) => (
                <div key={patient.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="mt-4 pt-4 border-t flex flex-wrap gap-2">
                    <Button size="sm" variant="outline" onClick={() => handlePatientAction("schedule", patient.id)}>
                      <Calendar className="w-4 h-4 mr-1" /> Schedule
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => handlePatientAction("message", patient.id)}>
                      <MessageSquare className="w-4 h-4 mr-1" /> Message
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => handlePatientAction("call", patient.id)}>
                      <Phone className="w-4 h-4 mr-1" /> Call
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => handlePatientAction("notes", patient.id)}>
