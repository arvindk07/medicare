...
import { Calendar as CalendarIcon, Clock, Plus, Edit, Trash2, Video, Phone } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          ...
          <form onSubmit={(e) => {e.preventDefault(); handleSaveAppointment(new FormData(e.currentTarget));}}>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Input 
                    id="date" 
                    type="date" 
                    defaultValue={editingAppointment?.date || (selectedDate ? format(selectedDate, "yyyy-MM-dd") : "")}
                    required 
                  />
                </div>
                <div className="grid gap-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select defaultValue={editingAppointment?.duration.toString() || "45"}>
                    <SelectTrigger>
