...
import { Calendar, Mail, Phone, MapPin, Clock, BookOpen, Brain, Plus, Trash2, Save, Star } from "lucide-react";
...
export const TherapistProfile = () => {
  ...
  const profile = {
    ...
    specialties: ["Cognitive Behavioral Therapy", "Depression", "Anxiety", "Trauma", "Stress Management"],
    education: [
      {
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              {isEditing && (
                <Button variant="outline" className="w-full" onClick={addSpecialty}>
