...
import { Calendar, Clock, Plus, Edit, Trash2, CalendarDays, Table, Users } from "lucide-react";
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  {editingSession ? "Update session details" : "Create a new therapy session"}
                </DialogDescription>
              </DialogHeader>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select value={formData.type} onValueChange={(value) => setFormData({...formData, type: value as SessionType})}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
      ...
      {viewMode === "table" ? (
              ...
              <TableBody>
                {sessions.map((session) => (
                  <TableRow key={session.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center">
                        {session.type === "Group" && <Users className="h-4 w-4 mr-1" />}
                        {session.type}
                      </div>
                    </TableCell>
                    <TableCell>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your sessions in calendar format</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-96 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">Showing {sessions.length} sessions</p>
              </div>
            </div>
          </CardContent>
        </Card>
