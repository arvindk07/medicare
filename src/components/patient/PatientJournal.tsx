...
import { FileText, Plus, Calendar, Search, Save, Smile, Meh, Frown } from "lucide-react";
...
export const PatientJournal = () => {
  ...
  const journalEntries = [
    {
      ...
      content: "Today was challenging but I remembered to use the breathing techniques Dr. Chen taught me. When the presentation at work started to make me anxious, I took a moment to breathe and center myself. It really helped!\n\nI'm proud of how I handled the situation and didn't let anxiety take over. Still working on not catastrophizing when things get stressful.",
      mood: 4
    },
    {
      id: 2,
      ...
      content: "Had to set boundaries with mom today about her comments on my career choices. It was hard but I maintained my ground without getting defensive. Used the assertive communication techniques we discussed in therapy.\n\nI felt anxious before the call, but afterward I felt empowered. Progress!",
      mood: 3
    },
    {
      id: 3,
      ...
      content: "Spent the weekend practicing self-care. Did a hike on Saturday which really cleared my head. Sunday I read and journaled. Feeling more centered than I have in weeks.\n\nNoticed I'm sleeping better when I avoid screens before bed. Want to make this a consistent habit.",
      mood: 5
    }
  ];
  ...
  const currentEntry = journalEntries.find(entry => entry.id === selectedEntry);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button className="bg-green-600 hover:bg-green-700" onClick={handleNewEntry}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardDescription>Track your thoughts and emotions</CardDescription>
              ...
              <div className="flex space-x-2">
                {[1, 2, 3, 4, 5].map((rating) => (
                  <Button
                    ...
                    className={`flex-1 ${moodRating === rating ? "bg-green-600 hover:bg-green-700" : ""}`}
