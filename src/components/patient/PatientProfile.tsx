...
export const PatientProfile = () => {
  ...
  const profile = {
    ...
    therapyGoals: "Manage anxiety, improve work-life balance, develop better coping mechanisms for stress",
    personalNotes: "I find journaling and meditation helpful. Struggle with public speaking and large social gatherings."
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <CardHeader>
            <div className="flex items-center space-x-4">
              <Avatar className="h-14 w-14">
                <AvatarFallback className="bg-green-100 text-green-800 text-xl">SJ</AvatarFallback>
              </Avatar>
              <div>
              ...
              <>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">{profile.emergencyContact}</div>
                  </div>
                </div>
              </>
            )}
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Your medical history and therapy preferences</CardDescription>
          </CardHeader>
            ...
            {isEditing ? (
              <>
                <div>
                  ...
                  <Textarea defaultValue={profile.medicalHistory} className="min-h-[100px]" />
                </div>
                
                <div>
                  <label className="block text-sm font-medium mb-1">Current Medications</label>
                  <Textarea defaultValue={profile.currentMedications} className="min-h-[100px]" />
                </div>
                
                <div>
                  <label className="block text-sm font-medium mb-1">Therapy Goals</label>
                  <Textarea defaultValue={profile.therapyGoals} className="min-h-[100px]" />
                </div>
                
                <div>
                  <label className="block text-sm font-medium mb-1">Personal Notes</label>
                  <Textarea defaultValue={profile.personalNotes} className="min-h-[100px]" />
                </div>
              </>
            ) : (
              <>
                ...
                <div>
                  <h3 className="font-medium text-lg mb-2">Current Medications</h3>
                  <p className="text-gray-700">{profile.currentMedications}</p>
                </div>
        ...
        <CardContent className="flex flex-col md:flex-row md:items-center gap-6">
          <div className="flex items-center gap-4">
            <Avatar className="h-16 w-16">
              <AvatarFallback className="bg-blue-100 text-blue-800 text-xl">MC</AvatarFallback>
            </Avatar>
            <div>
              <h3 className="font-medium text-lg">Dr. Michael Chen</h3>
              <p className="text-gray-600">Clinical Psychologist</p>
              <p className="text-sm text-gray-500">Specializes in Cognitive Behavioral Therapy</p>
            </div>
          </div>
