    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Configure your organization's wellness program settings</p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure default session and booking settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  <Label htmlFor="max-participants">Max Participants per Group Session</Label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="cancellation">Cancellation Policy (hours before)</Label>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="auto-approve">Auto-approve session bookings</Label>
                    <p className="text-sm text-gray-500">Automatically approve employee session requests</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="waitlist">Enable waitlists for full sessions</Label>
                    <p className="text-sm text-gray-500">Allow employees to join waitlists</p>
                  </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Send reminders before scheduled sessions</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="weekly-digest">Weekly wellness digest</Label>
                    <p className="text-sm text-gray-500">Send weekly engagement summaries</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Confirm when sessions are booked or cancelled</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="monthly-reports">Monthly reports to managers</Label>
                    <p className="text-sm text-gray-500">Send department wellness reports to managers</p>
                  </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Allow employees to book their own sessions</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Let employees update their profiles</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Collect feedback after sessions</p>
                  </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Remove personal identifiers from reports</p>
                  </div>
