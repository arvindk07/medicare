    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage your organization's employees and their wellness participation</p>
        </div>
              ...
              <tbody>
                {filteredEmployees.map((employee) => (
                  <tr key={employee.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-gray-600">{employee.sessionsCompleted}</td>
                    <td className="py-3 px-4 text-gray-600">{employee.lastSession}</td>
                    <td className="py-3 px-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">Avg Sessions/Employee</span>
                <span className="text-sm font-medium">
                  {Math.round(mockEmployees.reduce((sum, emp) => sum + emp.sessionsCompleted, 0) / mockEmployees.length)}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">Participation Rate</span>
                <span className="text-sm font-medium">
                  {Math.round((mockEmployees.filter(emp => emp.sessionsCompleted > 0).length / mockEmployees.length) * 100)}%
                </span>
              </div>
            </div>
          </CardContent>
