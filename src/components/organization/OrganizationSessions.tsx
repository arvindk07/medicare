...
import { Calendar, Clock, Users, Plus, Filter, Search, Eye, Edit, Trash2, CalendarDays } from "lucide-react";
...
export const OrganizationSessions = () => {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case "Group Session": return "bg-purple-100 text-purple-800";
      case "Individual Session": return "bg-green-100 text-green-800";
      case "Workshop": return "bg-orange-100 text-orange-800";
      case "Support Group": return "bg-pink-100 text-pink-800";
      default: return "bg-gray-100 text-gray-800";
    }
  };
  ...
  const SessionForm = ({ session, onSubmit }: { session?: Session; onSubmit: (data: any) => void }) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Schedule and manage wellness sessions for your organization</p>
        </div>
        <div className="flex space-x-2">
          ...
          >
            {viewMode === "table" ? <CalendarDays className="w-4 h-4 mr-2" /> : <Eye className="w-4 h-4 mr-2" />}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {viewMode === "table" ? "View and manage all wellness sessions" : "Calendar view of sessions"}
          </CardDescription>
          {viewMode === "table" && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {sessions
                    .filter(session => session.date === selectedDate?.toISOString().split('T')[0])
                    .map(session => (
                  ...
                  {sessions.filter(session => session.date === selectedDate?.toISOString().split('T')[0]).length === 0 && (
