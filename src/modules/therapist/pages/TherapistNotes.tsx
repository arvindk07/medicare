            ...
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                {selectedNote && currentNote
                  ? `${currentNote.patientName} • ${formatDate(
                      currentNote.date
                    )}`
            ...
            <CardContent>
              {selectedNote === null && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <Input className="md:col-span-2" placeholder="Note Title" />
                </div>
              )}
