  ...
  const [clients] = useState<Client[]>([
    {
      ...
      totalSessions: 12,
      notes:
        "Making good progress with CBT techniques. Responds well to mindfulness exercises.",
    ...
    },
    {
      ...
      totalSessions: 8,
      notes:
        "Recently started therapy. Showing initial signs of improvement with behavioral activation.",
    ...
    },
    {
      ...
      totalSessions: 15,
      notes:
        "Working on communication skills. Has made significant progress in relationship dynamics.",
