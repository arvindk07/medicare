...
export default function OnBoarding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/30 p-4 rounded-md">
        ...
        <div className="bg-purple-500 py-3">
          <div className="py-4 flex justify-end ">
            <NeurowelButton
              type="button"
              label="Previous"
              neurowel_click_function={prevStep}
            />
            <NeurowelButton
              type="button"
              label="Next"
              neurowel_click_function={nextStep}
            />
          </div>
        </div>
