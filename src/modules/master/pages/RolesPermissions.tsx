...
export const RolesPermissions = () => {
  ...
  const [roles, setRoles] = useState<Role[]>([
    ...
    },
    {
      ...
      userCount: 8,
      permissions: ["users.read", "reports.read", "reports.export"],
      status: "Inactive",
    },
  ]);
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <ListGridChanger view={view} click_function={handleListGridToggler} />
      ...
      {view === "list" ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              All system roles and their permissions
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
