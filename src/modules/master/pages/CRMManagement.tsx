...
import { PageBuilder } from "@/components/master/PageBuilder";
import { FormBuilder } from "@/components/master/FormBuilder";
import { MenuManagement } from "@/components/master/MenuManagement";
...
export const CRMManagement = () => {
  ...
  const filteredOrganizations = organizations.filter((organization) => {
    return (
      organization.name
        .toLowerCase()
        .includes(searchTermOrganizations.toLowerCase()) ||
  ...
  console.log(
    "CRMManagement - filtered organizations:",
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm md:text-base text-gray-600">
            Manage customers, organizations, and website content
          </p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <TabsList className="grid w-full grid-cols-3 md:grid-cols-6 min-w-[600px] md:min-w-0">
            <TabsTrigger
              ...
              onClick={handleContactsTabClick}
            >
              Contacts
            </TabsTrigger>
            <TabsTrigger
              value="organizations"
              className="text-xs md:text-sm"
              onClick={handleOrganizationsTabClick}
            >
              Organizations
            </TabsTrigger>
            <TabsTrigger
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">
                  Coming soon: Interaction logging and management features.
                </p>
              </div>
            </CardContent>
          </Card>
