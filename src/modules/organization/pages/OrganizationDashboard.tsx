...
export const OrganizationDashboard = () => {
  ...
  const recentActivity = [
    {
      type: "session",
      message: "Marketing team completed group wellness session",
      time: "2 hours ago",
      status: "completed",
    },
    {
      type: "enrollment",
      message: "15 new employees enrolled in mental health program",
      time: "4 hours ago",
      status: "new",
    },
    {
      type: "issue",
      message: "IT department reported scheduling conflict",
      time: "6 hours ago",
      status: "pending",
    },
    {
      type: "session",
      message: "HR team scheduled stress management workshop",
      time: "1 day ago",
      status: "scheduled",
    },
  ];
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {session.department} • {session.attendees} attendees
                      </p>
