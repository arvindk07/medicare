  ...
  const billingHistory = [
    {
      ...
      amount: "$2,499.00",
      status: "Paid",
      description: "Enterprise Pro - Monthly Subscription",
    },
    {
      id: 2,
      date: "Dec 15, 2023",
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="border-l-4 border-blue-500">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gray-900">
                {currentPlan.sessionsUsed}
              </div>
              <p className="text-sm text-gray-600">
                of {currentPlan.sessionsIncluded} included
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Session usage breakdown by department
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {usageBreakdown.map((dept, index) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {dept.sessions} sessions this month
                      </p>
                    </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Current payment method and billing details
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
