  ...
  const resources = {
    recommended: [
      {
        ...
        duration: "5 min read",
        description:
          "Learn about the common symptoms of anxiety and how they affect your body and mind.",
      ...
      },
      {
        ...
        duration: "10 min",
        description:
          "Guided breathing exercises to help you manage acute anxiety and stress responses.",
      ...
      },
      {
        ...
        duration: "15 min",
        description:
          "An introduction to mindfulness practices for those new to meditation.",
    ...
    articles: [
      {
        ...
        duration: "8 min read",
        description:
          "Explore the latest research on how sleep affects mental health.",
      ...
      },
      {
        ...
        duration: "6 min read",
        description:
          "Learn practical techniques for establishing and maintaining healthy boundaries.",
      ...
      },
      {
        ...
        duration: "7 min read",
        description:
          "Identify common thought patterns that contribute to anxiety and depression.",
        author: "Dr. Michael Chen",
      },
    ],
    videos: [
      {
        ...
        duration: "12 min",
        description:
          "A guided video session teaching progressive muscle relaxation techniques.",
        author: "Dr. Emily Wilson",
      },
      {
        id: 8,
        ...
        duration: "18 min",
        description:
          "Learn how to identify and reframe negative thought patterns.",
        author: "Dr. Michael Chen",
      },
      {
        id: 9,
    ...
    audio: [
      ...
      },
      {
        ...
        duration: "15 min",
        description:
          "Practice mindfulness while walking with this guided audio.",
        author: "Dr. Sarah Williams",
      },
      {
        id: 12,
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">
            Educational materials for your therapy journey
          </p>
        </div>
