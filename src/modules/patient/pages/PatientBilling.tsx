        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                Due{" "}
                {format(new Date(billingInfo.nextPayment.date), "MMM d, yyyy")}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {billingInfo.paymentMethod.type} expires{" "}
                {billingInfo.paymentMethod.expiry}
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <TabsContent value="invoices">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  View and download your therapy session invoices
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="upcoming">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Sessions scheduled for billing
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
