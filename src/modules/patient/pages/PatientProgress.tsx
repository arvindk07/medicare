  ...
  const timelineEvents = [
    {
      ...
      desc: "Discussed anxiety management techniques",
    },
    {
      date: "May 15, 2025",
      title: "Therapy Session",
      desc: "Reviewed progress on communication skills",
    },
    {
      date: "May 8, 2025",
      title: "Therapy Session",
      desc: "Introduced new mindfulness exercises",
    },
    {
      date: "May 1, 2025",
      title: "Initial Assessment",
      desc: "Completed initial evaluation and set therapy goals",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your mood levels over time (higher is better)
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your anxiety levels over time (lower is better)
              </CardDescription>
            </CardHeader>
            <CardContent className="h-80">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Time spent on wellness activities (minutes)
              </CardDescription>
            </CardHeader>
            <CardContent className="h-80">
              <ResponsiveContainer width="100%" height="100%">
